...
//       {
//         icon: <IoSettingsOutline className="size-4 sm:size-5" />,
//         name: "Node.js",
//       },
//     ],
//     teamMembers: [
...
// }) => {
//   return (
//     <Card className="border p-4 sm:p-6 border-[#1A1A1A] bg-transparent rounded-2xl overflow-hidden hover:border-[#282828] transition-all duration-300">
...
//                 <div className="p-3 border-border rounded-full border">
//                   <div className="p-3 border-border rounded-full border">
//                     <div className="p-3 border-border rounded-full border">
...
//                   Web Designer
//                 </h3>
//                 <p className="text-xs md:text-sm font-semibold text-gray-25">
//                   Mumbai, India
//                 </p>
//               </div>
//             </div>
...
//               asChild
//             >
//               <Link href="/" className="flex items-center font-light! gap-2">
//                 Apply Now
...
//               <p className="text-sm">
//                 Experience - Minimum 1 year of professional web design
//                 experience.
//               </p>
//             </div>
//             <div className="flex items-center space-x-2">
...
//               <p className="text-sm">
//                 Skills - Proficiency in Adobe Creative Suite (Photoshop,
//                 Illustrator, etc.), strong understanding of UI/UX design
//                 principles, responsive design expertise.
//               </p>
//             </div>
//           </div>
...
//           {isExpanded && (
//             <>
//               <CardDescription className="relative border rounded-2xl p-5 sm:p-7">
//                 <div className="flex flex-col space-y-4">
//                   {/* Description Section */}
//                   <div className="space-y-3 z-3!">
//                     <h4 className="text-xl text-white">Job Description</h4>
//                     <p className="text-sm text-[#B3B3B3] leading-relaxed">
//                       As a Web Designer at DigitX, you will be responsible for
//                       creating visually stunning and user-friendly website
//                       designs. Working closely with our development and
//                       marketing teams, you will turn creative concepts into
//                       functional web interfaces that deliver exceptional user
//                       experiences. This role offers an opportunity to showcase
//                       your design expertise and contribute to a wide range of
//                       exciting projects for diverse clients.
//                     </p>

//                     <Badge
//                       variant="outline"
//                       className="py-2 flex gap-2 px-4 bg-transparent border-[#282828] text-primary-foreground hover:bg-[#1A1A1A] hover:border-[#404040] transition-colors"
//                     >
//                       <span>
//                         <Menu className="size-5"></Menu>
//                       </span>

//                       <span>Application Deadline: 30th September 2025</span>
//                     </Badge>
//                   </div>
//                 </div>
//               </CardDescription>
...
//                   {/* Description Section */}
//                   <div className="space-y-3 z-3!">
//                     <h4 className="text-xl text-white">Responsibilities</h4>

//                     <ul className="list-disc ml-4 flex space-y-2 flex-col">
//                       <li className="text-sm text-[#B3B3B3] leading-relaxed">
